...
- [Awesome Hacking](https://github.com/carpedm20/awesome-hacking) - Curated list of a bunch of hacking guides and tools (with a special focus on OSS like **Metasploit** to find exploits and **Wireshark** for decoding phone calls).
