...
function codeToHtml(context, code, options) {
  ...
  let result = toHtml(codeToHast(context, intput, options));
  for (const transformer of options.transformers || [])
...
export { addClassToHast, codeToThemedTokens, createSingletonShorthands, createdBundledHighlighter, getHighlighterCore, getShikiContext, isPlaintext, isSpecialLang, loadWasm, toArray, toShikiTheme, tokenizeAnsiWithTheme };
